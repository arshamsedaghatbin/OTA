...
import com.roma.domain.Address;
import com.roma.repository.AddressRepository;
import com.roma.service.AddressService;
import com.roma.service.dto.AddressDTO;
import com.roma.service.mapper.AddressMapper;
...
public class AddressResourceIntTest {
    ...
    private static final AddresType DEFAULT_ADDRES_TYPE = AddresType.MOBILE;
    private static final AddresType UPDATED_ADDRES_TYPE = AddresType.PHONE;
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAddresType()).isEqualTo(DEFAULT_ADDRES_TYPE);
    ...
    public void updateAddress() throws Exception {
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getAddresType()).isEqualTo(UPDATED_ADDRES_TYPE);
